...
<div class="section__content section__content--p30" style="background-color: rgb(228, 228, 228);">
    <div class="container-fluid">
            <div class="col-md-12">
                <!-- DATA TABLE -->
                <h3 class="title-1 m-b-1 m-t-30">Order List</h3>
                @php
                $total = 0;
                $count = 0;
                @endphp
                ...
                <div class="table-data__tool">
                    <div class="table-data__tool-right">
                        <a class="au-btn au-btn-icon au-btn--green au-btn--small" href="{{url('order-history')}}">
                            <i class="zmdi zmdi-plus"></i>History Order</a>
                    </div>
                </div>
