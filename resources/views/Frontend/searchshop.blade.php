                ...
                <div class="sidebar bg-white">
                    <div class="sidebar__item shadow p-4">
                        ...
                        <ul>
                            ...
                            <li><a href="{{url('shop-product-category/'.$shops->id.'/'.$category = 'Vegetables')}}">Household</a></li>
                            <li><a href="{{url('shop-product-category/'.$shops->id.'/'.$category = 'Household')}}">Drinks</a></li>
